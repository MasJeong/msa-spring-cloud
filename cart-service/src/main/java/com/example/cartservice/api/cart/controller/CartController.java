package com.example.cartservice.api.cart.controller;

import com.example.cartservice.api.cart.domain.CartItem;
import com.example.cartservice.api.cart.service.CartService;
...
@RequestMapping("/cart-service/api/v1/carts")
public class CartController {
     ...
     *
     * @param userId 사용자 ID
     * @return 장바구니 내용 (Key: 상품 ID, Value: CartItem 객체)
     */
    @GetMapping("/{userId}")
